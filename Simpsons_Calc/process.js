           ...
           if(i > 0 && i != n)
             {
               if (i%2 == 1)
               {
                 ...
                 console.log(i);
                 append(4*(math.evaluate(indexAns)),i);
                 approx[i] = 4*(math.evaluate(indexAns));
               }
               if (i%2 == 0)
               {
               console.log("greater than 0 and less than n"+ indexAns);
    ...
    function ans_trueVal()
     {
       ...
       true_val = (trngle_trueVal()/3)*sum;
       return (trngle_trueVal()/3)*sum;
     }
    ...
    function append(a,b)
     {   
       ...
       if(b > 0 && b != n)
       {
         if(b%2 == 1)
         {
           var node = document.createTextNode("4f(x" + b + ") = " + a);
         }
         else if(b%2 == 0)
         {
    ...
    function tru_ValProcess()
     {
       ...
       n++;
       n++;
       console.log("this is 2nd index " + n);
       trngle_trueVal();
    ...
    function Alrt()
     {
       alert("Number of rectangles should be an even number. Please try changing the number of rectangles");
       return false;
